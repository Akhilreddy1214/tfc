...
const PaymentPage = () => {
    ...
    return (
        <>
        <FoodNavbar />
        <h4 className="mainHeading">Secure CheckOut</h4>
        <div className='container-fluid PaymentFUllPage'>
                        ...
                        <div className="card-header">
                            ...
                            <ul role="tablist" className="nav  nav-pills rounded nav-fill mb-3">
                                    <li className="nav-item">
                                        ...
                                        >
                                           <span><i classN="bi bi-credit-card mx-2 fs-5 fw-bold"></i></span> Credit Card
                                        </button>
                                    </li>
                                    <li className="nav-item">
                                        <button
                                        ...
                                        >
                                          <span><i className="bi bi-paypal mx-2 fs-5 fw-bold"></i></span>  Paypal
                                        </button>
                                    </li>
                                    <li className="nav-item">
                                        <button
                            ...
                            <div id="credit-card" className={`tab-pane fade ${activeTab === 'credit-card' ? 'show active' : ''} pt-3`}>
                                    <form role="form" onSubmit={(e) => e.preventDefault()}>
                                        <div className="form-group">
                                            <label htmlFor="username"><h6>Card Owner</h6></label>
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <div className="col-sm-4">
                                                <div className="form-group mb-4">
                                                    <label htmlFor="cvv"><h6>CVV</h6></label>
                                                    <input type="text" name="cvv" required className="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card-footer">
                                            <button type="button" className="btn ButtonAll btn-block shadow-sm">Confirm Payment</button>
                                        </div>
                                    </form>
                                </div>
                                <div id="paypal" className={`tab-pane fade ${activeTab === 'paypal' ? 'show active' : ''} pt-3`}>
                                    ...
                                    <p>
                                        <button type="button" className="btn ButtonAll">Log into my Paypal</button>
                                    </p>
                                ...
                                <div id="net-banking" className={`tab-pane fade ${activeTab === 'net-banking' ? 'show active' : ''} pt-3`}>
                                    <div className="form-group">
                                        <label htmlFor="Select Your Bank"><h6>Select your Bank</h6></label>
                                    ...
                                    <div className="form-group">
                                        <button type="button" className="btn ButtonAll">Proceed Payment</button>
                                    </div>
                                    <p className="text-muted">
                                        Note: After clicking on the button, you will be directed to a secure gateway for payment. After completing the payment process, you will be redirected back to the website to view details of your order.
                                    </p>
